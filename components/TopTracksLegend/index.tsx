...
import "./TopTracksLegend.css";

export default function TopTracksLegend() {
  return (
    <div className="h-[32px] sticky border-b border-solid border-[#FFFFFF11] mb-6 flex flex-row px-6">
      <div className="grid top-tracks-grid gap-4">
        <div
        ...
        <div
          role-header="column-header"
          aria-colindex={5}
          className="flex flex-row items-center justify-end min-w-[28px] mr-8"
        >
          <span>
            <Image
